...
export default function TransliteratorPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-2xl mx-auto">
      <h1 className="text-xl font-bold text-maya-gold mb-1">{t.transliteratorTitle}</h1>
      <p className="text-xs text-maya-muted mb-4">{t.transliteratorSubtitle}</p>
        ...
        <>
          ...
          {result && (
            <div className="bg-maya-surface rounded-xl p-5 border border-maya-border space-y-4">
              ...
              <div>
                <div className="text-xs text-maya-muted mb-2">{t.syllables}:</div>
              ...
              {result.dictMatch && (
                <div className="border-t border-maya-border pt-3">
                  <div className="text-xs text-confidence-confirmed mb-1">● {t.dictMatch}:</div>
                  <div>
              ...
              <div className="flex items-center gap-2 text-sm">
                <span className="text-maya-muted">{t.overallConfidence}:</span>
